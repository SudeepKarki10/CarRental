  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center w-fit absolute top-36 left-6 md:left-20 z-30 mb-10">
        ...
        <br />
        <p className="text-lg font-semibold">Home/Contact</p>
      </div>
      ...
      <div className="container-div relative mt-96 ">
        <div className="bg-white dark:bg-gray-900" id="contact">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 grid md:grid-cols-2 lg:grid-cols-2 gap-y-8 md:gap-x-8 md:gap-y-8 lg:gap-x-8 lg:gap-y-16">
            <div>
              <h2 className="text-3xl ssm:text-5xl font-extrabold dark:text-gray-100">
                Need additional information?
              </h2>
              <p className="max-w-sm text-xl mt-8 mb-4 dark:text-gray-400">
                A multifaceted professional skilled in multiple fields of
                research, development as well as a learning specialist. Over 15
                years of experience.
              </p>
              <div className="flex items-center mt-8 space-x-2 text-black text-lg font-semibold ">
                <svg
              ...
              <div className="flex items-center mt-2 space-x-2 text-black text-lg font-semibold">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                ...
                <a href="mailto:hello@company.com">carrental@company.com</a>
              </div>
              <div className="flex items-center mt-2 space-x-2 text-black text-lg font-semibold">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <a href="tel:11111111111">+977 9800000000</a>
              </div>
            </div>
            <div>
              <form>
                ...
                <button
                  type="submit"
                  className="w-full py-4 font-semibold text-white transition-colors bg-orange-600 rounded-md hover:bg-orange-500 focus:outline-none focus:ring-offset-2 focus:ring focus:ring-gray-200 px-7 dark:bg-white dark:text-black "
                >
                  Send Message
                </button>
              </form>
